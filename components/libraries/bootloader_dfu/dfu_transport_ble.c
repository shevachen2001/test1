...
#define APP_ADV_INTERVAL                    MSEC_TO_UNITS(400, UNIT_0_625_MS)    // MSEC_TO_UNITS(25, UNIT_0_625_MS)                        /**< The advertising interval (25 ms.). */
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
	     BLE_UPDATA_DISCONNECT_TIMER(120000/64);
