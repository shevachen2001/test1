...
#if 1//(defined LORA_ENABLE) && (LORA_ENABLE == STD_TRUE)
#define PSTORAGE_FLASH_PAGE_END    254 //240// 254//pstorage_flash_page_end()
#else
#define PSTORAGE_FLASH_PAGE_END    240// 254//pstorage_flash_page_end()
#endif

#define PSTORAGE_NUM_OF_PAGES       (2 + 7/*NRF_FLASH_END*/)                                                           /**< Number of flash pages allocated for the pstorage module excluding the swap page, configurable based on system requirements. */
